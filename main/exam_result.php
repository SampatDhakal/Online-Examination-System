...
if(isset($_GET['ec']))
{
	...
	$object->query = "
	SELECT student_oea.student_name, student_to_class_oea.class_id, student_to_class_oea.student_roll_no FROM student_oea 
	INNER JOIN student_to_class_oea 
	ON student_to_class_oea.student_id = student_oea.student_id 
	WHERE student_oea.student_id = '".$_SESSION["student_id"]."'
	";
	...
	foreach($result as $row)
	{
		...
		INNER JOIN exam_subject_question_oea 
		ON exam_subject_question_oea.exam_subject_question_id = exam_subject_question_answer.exam_subject_question_id 
		WHERE exam_subject_question_oea.exam_subject_id = '".$row["exam_subject_id"]."'
		";
