...
if(isset($_POST["action"]))
{
	...
	{
		$order_column = array('student_oea.student_roll_no', 'student_oea.student_name', 'class_oea.class_name', 'student_to_class_oea.added_on');

		$output = array();

		$main_query = "
		SELECT * FROM student_to_class_oea 
		INNER JOIN class_oea 
		ON class_oea.class_id = student_to_class_oea.class_id 
		...
		if(isset($_POST["search"]["value"]))
		{
			...
			$search_query .= 'OR student_oea.student_name LIKE "%'.$_POST["search"]["value"].'%" ';
			$search_query .= 'OR student_to_class_oea.student_roll_no LIKE "%'.$_POST["search"]["value"].'%" ';
		}
		...
		{
			$order_query = 'ORDER BY student_to_class_oea.student_to_class_id DESC ';
		}
	...
	if($_POST["action"] == 'Add')
	{
		...
		else
		{
			...
			$object->query = "
			INSERT INTO student_to_class_oea 
	...
	{
		$object->query = "
		DELETE FROM student_to_class_oea 
