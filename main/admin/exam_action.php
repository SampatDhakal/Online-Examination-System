...
if(isset($_POST["action"]))
{
	...
	{
		$order_column = array('exam_oea.exam_title', 'class_oea.class_name', 'exam_oea.exam_duration', 'exam_oea.exam_result_datetime', 'exam_oea.exam_status');
		...
		ON class_oea.class_id = exam_oea.exam_class_id 
		";
		...
		if(isset($_POST["search"]["value"]))
		{
			...
			$search_query .= 'OR exam_oea.exam_title LIKE "%'.$_POST["search"]["value"].'%" ';
			$search_query .= 'OR exam_oea.exam_duration LIKE "%'.$_POST["search"]["value"].'%" ';
			$search_query .= 'OR exam_oea.exam_result_datetime LIKE "%'.$_POST["search"]["value"].'%" ';
			$search_query .= 'OR exam_oea.exam_status LIKE "%'.$_POST["search"]["value"].'%" ';
		}
		...
		{
			$order_query = 'ORDER BY exam_oea.exam_id DESC ';
		}
