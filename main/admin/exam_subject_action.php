...
if(isset($_POST["action"]))
{
	...
	{
		$order_column = array('exam_oea.exam_title', 'subject_oea.subject_name', 'subject_wise_exam_detail.subject_exam_datetime', 'subject_wise_exam_detail.subject_total_question', 'subject_wise_exam_detail.marks_per_right_answer', 'subject_wise_exam_detail.marks_per_wrong_answer');
	...
	if($_POST['action'] == 'fetch_subject')
	{
		...
		ON subject_to_class_oea.class_id = exam_oea.exam_class_id 
		INNER JOIN subject_oea 
