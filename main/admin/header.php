    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">Administraion panel</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#exam_collapse" aria-expanded="false" aria-controls="exam_collapse">
                    ...
                    <span>MultipleChoice exam</span>
                </a>
                <div id="exam_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="exam.php">Exam Management</a>
                        <a class="collapse-item" href="exam_subject.php"> Exam Subject</a>
                        <a class="collapse-item" href="exam_subject_question.php">Exam Question</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#pexam_collapse" aria-expanded="false" aria-controls="exam_collapse">
                    <i class="fas fa-edit"></i>
                    <span>LabworkBased exam</span>
                </a>
                <div id="pexam_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="pexam.php">Exam Managemnet</a>
                        <a class="collapse-item" href="exam_projectsubject.php">Exam Subject</a>
                        <a class="collapse-item" href="exam_Answer.php">Exam Answer Paper</a>
                    </div>
                </div>
            </li>
