...
if(isset($_GET["ec"]))
{
    $ec = $_GET["ec"];
    $object->query = "
    SELECT exam_id, exam_result_datetime FROM exam_oea 
                                        ...
                                        else
                                        {
                                            if(time() > strtotime($end_time))
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        $action_button = '<a href="single_subject_result.php?ec='.$ec.'&esc='.$row["subject_exam_code"].'" target="_blank" class="btn btn-danger btn-sm">Result</a>';
                                                    }
                                                    else
                                                    {
                                                        $action_button = '';
